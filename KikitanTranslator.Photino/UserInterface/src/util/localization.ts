export const localization = {
    ...
    change_theme_detail: {
        ...
        jp: "右上のテーマボタンからアプリのテーマを変更できます（クリックするとアイコンも変わります！）",
    ...
    not_appimage_warning: {
        ...
        jp: "Kikitanは、お使いのディストリビューションのパッケージマネージャーからインストールされています。アップデートもパッケージマネージャーから行ってください。AppImage版をインストールすると、ディストリビューションのパッケージマネージャーを介さずにアップデートを受け取れます。",
    ...
    windows_mic_details: {
        ...
        jp: "Windowsのマイク設定を確認し、VRヘッドセットのマイク（または使用するマイク）が既定のマイクとして選択されていることを確認してください。既定のマイクを変更した場合は、Kikitanを再起動してください！",
    ...
    muted_in_game: {
        ...
        jp: "ゲーム内でミュート中です。Kikitanを使用するには、設定の「ゲーム内でミュート中はKikitanを無効にする」をオフにするか、VRChatでミュートを解除してください！",
    ...
    mode_selection_details: {
        ...
        jp: "ここからモードを変更できます。翻訳モードでは音声を指定した言語へ翻訳し、STTモードでは翻訳せずに音声を文字起こしします。ゲーム内で声を出したくない場合に、チャットボックスへ手入力する代わりとして利用できます。",
    ...
    settings_details: {
        ...
        jp: "右上の設定ボタンからKikitanの設定を変更できます！",
    ...
    disable_kikitan_when_muted_tooltip: {
        ...
        jp: "有効にすると、ゲーム内でミュート中はKikitanが音声を認識しません。",
        cn: "启用此选项后，当您在游戏中被静音时，Kikitan将不会识别您的声音",
        kr: "이 기능을 활성화하면 게임에서 음소거 상태일 때 Kikitan이 음성을 인식하지 않습니다",
    },
    send_to_chatbox_without_waiting: {
        en: "Send to Chatbox/Overlay without waiting",
        jp: "認識結果の確定を待たずにチャットボックス/オーバーレイへ送信",
        cn: "无需等待，直接发送到聊天框/叠加层",
    ...
    send_to_chatbox_without_waiting_tooltip: {
        ...
        jp: "有効にすると、音声認識の途中結果もチャットボックスへ送信し、デスクトップ音声の認識結果もデスクトップオーバーレイへ表示します（有効な場合）。VRChatでは短時間に多数のメッセージを送信するとレート制限にかかりやすいため注意してください！",
    ...
    do_not_send_original_tooltip: {
        ...
        jp: "有効にすると、チャットボックスには翻訳文のみを送信します。",
    ...
    desktop_translation_details: {
        ...
        jp: "ここからデスクトップ翻訳を有効にできます。他の人の音声を認識して翻訳し、その内容を表示します。VRを使用していない場合はメインモニターの下部に、VRを使用している場合は視野中央の下側に表示されます（現在はWindowsのみ対応）。",
    ...
    thank_you_details: {
        ...
        jp: "Kikitanは今後も無料のオープンソースソフトウェアとして提供されます。プロジェクトを支援していただける場合は、Buy Me a CoffeeまたはBooth.pmからご支援いただけます！",
    ...
    slow: { en: "Slow", jp: "遅い", cn: "慢", kr: "느림" },
    medium: { en: "Medium", jp: "標準", cn: "中等", kr: "보통" },
    fast: { en: "Fast", jp: "速い", cn: "快", kr: "빠름" },
    osc_address: {
        en: "OSC Address",
        jp: "OSCアドレス",
        cn: "OSC地址",
    ...
    english_gender_text: {
        ...
        jp: "英語への翻訳時に代名詞の性別を指定します（例：He is a doctor / She is a doctor）。文法上の性別を明示しない言語から翻訳する場合に便利です。",
    ...
    unable_to_access_google_servers: {
        ...
        jp: "Googleのサーバーにアクセスできません。ファイアウォールで通信がブロックされていないか確認してください。Googleへのアクセスが制限されている地域（例：中国）では、VPNが正常に動作しているか確認してください！",
    ...
    donation_text: {
        ...
        jp: "Kikitanは無料で、今後も無料で提供されます。とはいえ、ご支援いただけると大変助かります！私はまだ学生のため、いただいたご支援は生活の大きな助けになります。Kikitanを気に入っていただけたら、寄付をご検討ください！",
    ...
    enable_user_data: {
        ...
        jp: "音声認識・翻訳データをOSCメッセージとして送信（ポート7272）",
    ...
    invalid_api_key_gemini: {
        ...
        jp: "GeminiのAPIキーが無効です。APIキーを確認して、もう一度お試しください。",
    ...
    limit_reached: {
        ...
        jp: "このサービスの利用上限に達しました（無料枠の制限による可能性があります）。別の翻訳サービスまたは音声認識サービスに切り替えるか、上限がリセットされるまでお待ちください。",
    ...
    microphone_updated: {
        ...
        jp: "以前使用していたマイクが見つかりません。既定のマイクに切り替えます。",
    ...
    cannot_use_webspeech_for_desktop_translation: {
        ...
        jp: "WebSpeechはデスクトップ翻訳では使用できません。デスクトップ翻訳を使用するには、音声認識サービスを変更してください！",
    ...
    translation_disabled_muted: {
        ...
        jp: "ゲーム内でミュート中のため、Kikitanは無効になっています。発言内容がゲーム内に表示されない場合は、設定の「ゲーム内でミュート中はKikitanを無効にする」をオフにしてください！",
    ...
    translation_disabled: {
        ...
        jp: "翻訳は無効です。音声文字起こし（STT）モードから翻訳モードへ切り替えると有効になります。",
