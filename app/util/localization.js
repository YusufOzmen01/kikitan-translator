export const localization = {
    ...
    steamvr_connection: {
        en: "SteamVR Connection",
        jp: "SteamVR 接続",
        cn: "SteamVR 连接",
        tr: "SteamVR Bağlantısı"
    },
    language_settings: {
    ...
    omit_questionmark: {
        en: "Omit the trailing question mark",
        jp: "文末の疑問符を省略",
        cn: "请省略句尾的问号",
        tr: "Soru işaretini kaldır"
    },
    translation_first: {
    ...
    dont_send_when_muted: {
        en: "Don't send chatbox messages when muted (Only translation mode)",
        jp: "ミュート時にチャットボックスメッセージを送信しない（翻訳モードのみ）",
        cn: "静音时不发送聊天框消息（仅限翻译模式）",
        tr: "Sessizken sohbet kutusu mesajları gönderme (Sadece çeviri modu)"
    }
}